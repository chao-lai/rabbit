...
export type CoreUserResponseFragment = (
  { __typename?: 'UserResponse' }
  & { errors?: Maybe<Array<(
    { __typename?: 'FieldError' }
    & CoreErrorFragment
...
export type PostsQuery = (
  ...
  & { posts: Array<(
    { __typename?: 'Post' }
    & Pick<Post, 'updatedAt' | 'id' | 'title' | 'text' | 'createdAt' | 'creatorId'>
  )> }
);
